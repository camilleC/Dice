...
public class StateLobby implements State{
	...
	public int join(int id, String[] request){
			...
			////is changing state b/f returning.  
			if (myGame.getPlayerCount() == 3){
				System.err.print("in if before state change   " + id );
				myGame.setState(Game.GameState.TIMERLOBBY);
			}
			return 0;
			}
	...
	//public void changeState(State newState){this.myGame.setState(newState);}
}
